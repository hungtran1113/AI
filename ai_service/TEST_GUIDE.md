...
### 📝 Commit message cho file này:

Vì đây là file hướng dẫn bổ sung cho tài liệu, bạn hãy sử dụng commit message sau để đồng bộ với các bước trước:

* **Tiếng Anh (Chuẩn):** `docs: add testing guide for AI sentiment analysis`
* **Tiếng Việt:** `docs: thêm hướng dẫn nhập liệu kiểm tra mô hình AI`

**Cách thực hiện trong Terminal:**
```bash
git add TEST_GUIDE.md
git commit -m "docs: add testing guide for AI sentiment analysis"
